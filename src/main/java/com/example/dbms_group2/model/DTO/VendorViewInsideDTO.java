...
public class VendorViewInsideDTO {
    ...
    public VendorViewInsideDTO(int boothId, int boothCode, Long id, String name, String description, String facebook, String instagram, String line, String website, String imageUrl, BigDecimal rating, Integer favorited, String zoneIndex, String zoneCode, String zoneName) {
