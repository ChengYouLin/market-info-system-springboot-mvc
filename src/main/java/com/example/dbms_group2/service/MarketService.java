...
public class MarketService {
    ...
    public void saveMarketSettings(String marketName, String location, Date recruitStartDate, Time recruitStartTime, Date recruitEndDate, Time recruitEndTime, String email, String facebook, String instagram, String line, String website, String specialId) {
    ...
    public void saveMarketSettingsPeriod(List<EventPeriodDTO> eventPeriodDTOS, String email) {
        ...
        if (eventPeriodDTOS != null || !eventPeriodDTOS.isEmpty()) {
