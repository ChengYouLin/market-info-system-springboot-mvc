...
public interface OpeningRepository extends JpaRepository<Opening, Long> {
    ...
    @Query("SELECT new com.example.dbms_group2.model.DTO.TimeSlotDTO(o.date, o.startTime, o.endTime) FROM Opening o " +
            "WHERE o.market.marketId = :marketId")
    List<TimeSlotDTO> findTimeSlot(@Param("marketId") int marketId);
}
